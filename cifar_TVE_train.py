...
working_CNNs = [Net() for i in range(num_workers)]
...
for epoch in range(2):  # loop over the dataset multiple times
    ...
    for i, big_batch in enumerate(trainloader, 0):
        ...
        for k in range(num_workers):
            ...
            inputs = big_inputs[effective_batch_size*k : effective_batch_size*(k+1)]
            labels = big_labels[effective_batch_size*k : effective_batch_size*(k+1)]
